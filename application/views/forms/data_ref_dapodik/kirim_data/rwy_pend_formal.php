								...
								<tr>
									<td>
										<div class="form-check">
											<input type="checkbox" class="form-check-input" name="kirim_data[]" value="<?= $encrypt ?>" id="<?= $value->riwayat_pendidikan_formal_id ?>">
											<label class="form-check-label" for="<?= $value->riwayat_pendidikan_formal_id ?>">
												<?php
												if($cekPTK){
													echo $cekPTK['nama'];
												}
